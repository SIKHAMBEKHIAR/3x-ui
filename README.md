...
```
bash <(curl -Ls https://raw.githubusercontent.com/SIKHAMBEKHIAR/3x-ui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/SIKHAMBEKHIAR/3x-ui/master/install.sh) v2.2.6
```
